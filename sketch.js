...
/*1º passo- definir o gameOver para falso */
...
function showBoats() {
  if (boats.length > 0) {
    ...
    /*2 º- passo nós escrevemos o loop for para obter todos os návios da matriz boats, assim
   sua velocidade e animação e vamos usar a Matter.SAT.collides para verifcar a  colisão 
   entre  torre e navio */
    for (var i = 0; i < boats.length; i++) {
      ...
      var collision = Matter.SAT.collides(this.tower, boats[i].body);
        /*3º passo- caso  ocorra a colisão deixar sinalizador de game over para 
        verdadeiro  */
      if (collision.collided && !boats[i].isBroken) {
        ...
        // e comentar o sinalizador que vai ser a risada do pirata
        // isGameOver = true;
        gameOver();
      }
    }
...
/*6º- passo  criamos a função gameOver */
function gameOver() {
  swal(
    {
      title: `Fim de Jogo!!!`,
